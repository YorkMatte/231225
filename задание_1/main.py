...
from PyQt6.QtWidgets import QMainWindow, QApplication, QStyledItemDelegate, QFileDialog, QTableWidgetItem
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(20, 50, 651, 481))
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        delegate = ItemDelegate(self.ui.tableWidget)
        self.ui.tableWidget.setItemDelegateForColumn(3, delegate)

        self.ui.tableWidget.cellDoubleClicked.connect(self.on_double_clicked)
    ...
    def on_double_clicked(self, row, column):
        if column == 3:
            ...
            if not pixmap.isNull():
                pixmap_t = pixmap.scaled(
                    80,80,
                    Qt.AspectRatioMode.KeepAspectRatio,
                    Qt.TransformationMode.SmoothTransformation
                )
                item = QTableWidgetItem()
                item.setData(Qt.ItemDataRole.DecorationRole, pixmap_t)
